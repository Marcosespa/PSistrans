...
public interface EmpleadoRepository extends JpaRepository<Empleado, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE empleados SET tipo = :tipo, tipoDocumento = :tipoDocumento,nombre = :nombre, nacionalidad =: nacionalidad, direccionFisica =: direccionFisica,direccionElectronica =: direccionElectronica ,codigoPostal=: codigoPostal, ciudad=:ciudad, departamento:=departamento,cargo=: cargo  WHERE numero_documento = :numero_documento", nativeQuery = true)
    void actualizarEmpleado(@Param("numero_documento") long numero_documento,
